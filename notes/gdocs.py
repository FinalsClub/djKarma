...
def convertWithGDocs(self, Note):
    # Create a client class which will make HTTP requests with Google Docs server.
    client = gdata.docs.service.DocsService()
    # Authenticate using your Google Docs email address and password.
    client.ClientLogin('Andrew@karmanotes.org', 'Buddha11')
    ...
    uploaded_file = client.Upload(media_source=fileToUpload, title='BART Station List', folder_or_uri=collection_child)
    client.Download(entry_or_id_or_url=uploaded_file, file_path='/Users/dbro/Documents/python/bart_converted.html')
